...
{
    public class ChargeCardRepository : BaseRepository<ChargeCard>, IChargeCardRepository
    {
        public ChargeCardRepository(dbpaymentmarketContext context) : base(context)
        {
        }
    }
}